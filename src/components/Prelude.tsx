    ...
    <section ref={ref} className="section-padding bg-gray-50">
      <div className="max-w-5xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute -top-3 xs:-top-4 sm:-top-6 left-1/2 transform -translate-x-1/2">
            <div className="p-1.5 xs:p-2 sm:p-3 bg-green-100 rounded-full border-2 sm:border-4 border-white shadow-lg">
              <TreePine className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 text-green-600" />
            </div>
          </div>
